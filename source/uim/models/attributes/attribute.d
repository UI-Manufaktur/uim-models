...
**********************************************************************************************************/
module uim.models.attributes.attribute;
...
class DAttribute : DEntity, IAttribute {
 ...
 /*  O attribute(this O)(UUID myId, size_t myMajor = 0, size_t myMinor = 0) { 
  ...
  version(test_uim_oops) { unittest {    /// TODO
    }
  }
...
// auto Attribute(DETBCollection aCollection, Json json) { return (new DAttribute(json)).collection(aCollection); }